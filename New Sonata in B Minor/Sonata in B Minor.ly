...
flute = \relative c''
{
	...
	d'4( c~ c a | fis2) d'4 g~ | g c g8 e c4( | d1) | d4( c~ c a-.) | r a a2 | d4( b~ b g-.) | r g g2 | d'4( c~ c a | dis2) g4( d~ | d) a_( d8 fis, a4 | b1) |
}
...
upper = \relative c''
{
	...
	<b g'>4( <c e c'>~ <c e c'> <e c' e>) | <d a' d>2~ <d a' d>4 r | d <c a' e'>4~ <c a' e'>2 | <g' g'>1 | <b g'>4( <a e'>~ <a e'>) r | r1 | <d, a'>4( <d b'>~ <d b'>) r | r1 | <b g'>4( <c e c'>~ <c e c'> <e c' e>) | <dis g c>2~ <dis g c>4 <fis d'>4~ | <fis d'> <fis a d>~ <fis a d>2 | <d g d'>1 |
}
